...
hxex.config.Output_DIR = os.path.join("/data/tuttle/HDX-MS/Chris_B5_disease/SpecExport/batchrun_1pop_15Aug2024/WT_run")
...
filtered = hxex.filter_df(metadf,samples="WT")
