...
import config_b5disease_1pop as config  ### <- modify as needed

hxex_name = "hxex_updating" ### <- use desired version of pyhxexpress 
config_file_name = "config_b5disease_1pop" ### <- set this so it updates value in output script
...
hxex.config.Output_DIR = os.path.join(hxex.config.Data_DIR,'batchrun_1pop_'+str(config.date))
